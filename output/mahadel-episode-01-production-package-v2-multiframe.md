            ...
            "frames": [
              {
                ...
                "startSecond": 0,
                "endSecond": 3,
                "actionPrompt": "建立场景与动作入口：黑湖与倒悬古塔建立空间；Karin低头，完整剑刃贴在掌心，四只手刚刚扣住",
                "imagePrompt": "静态关键帧：黑湖无波，倒悬古塔与Karin模糊倒影对齐；雪地中央四只手刚刚扣住，Karin低头看向掌心的完整剑刃；可见状态：动作入口已成立，主体处于可辨识准备姿态；可见表演状态：表情与视线落在动作入口，手部与道具形成明确起点关系；必要连续性：人物身份、服装、道具材质、空间轴线和光向连续；只呈现当前时间点已经发生的静态结果，不表现运动过程。"
              },
              {
                "id": "SH001-F02",
                "sequenceIndex": 2,
                "startSecond": 3,
                "endSecond": 6,
                "actionPrompt": "镜头推进并改变主体状态：镜头向雪地与四只手推进；Karin抬头看向倒悬古塔，双手收紧，完整剑刃出现第一道银色裂纹",
                "imagePrompt": "静态关键帧：雪地中央四只手彼此扣紧；Karin抬头看向倒悬古塔，双手收紧，完整剑刃出现第一道银色裂纹；可见状态：镜头推进后主体重心、视线或手部位置已经改变；可见表演状态：表情由疑惑转为戒备，视线锁定关键道具，手部保持明确接触关系；必要连续性：人物身份、服装、道具材质、空间轴线和光向连续；只呈现当前时间点已经发生的静态结果，不表现运动过程。"
              },
              {
                "id": "SH001-F03",
                "sequenceIndex": 3,
                "startSecond": 6,
                "endSecond": 9,
                "actionPrompt": "镜头推进并改变主体状态：剑刃从掌心断口向外裂开，冷银碎屑飞出；Karin眉眼骤然睁大，下颌绷紧，四只手仍扣住断剑",
                "imagePrompt": "静态关键帧：剑刃已经从掌心断口向外裂开，冷银碎屑停在断口周围；Karin眉眼骤然睁大、下颌绷紧，四只手仍扣住断剑；可见状态：关键动作已经发生，道具或环境出现可见结果；可见表演状态：表情由疑惑转为戒备，视线锁定关键道具，手部保持明确接触关系；必要连续性：人物身份、服装、道具材质、空间轴线和光向连续；只呈现当前时间点已经发生的静态结果，不表现运动过程。"
              },
              {
                "id": "SH001-F04",
                "sequenceIndex": 4,
                "startSecond": 9,
                "endSecond": 12,
                "actionPrompt": "执行关键动作：裂纹扩展成断口，镜头落到冷银碎片；Karin手指仍扣住剑刃，视线从断口转向无法解释的裂痕",
                "imagePrompt": "静态关键帧：冷银断口占据前景中心，Karin手指扣住碎裂剑刃，视线锁定断口，银色碎屑停在掌心附近；可见状态：结果状态继续发展，主体反应或道具关系已经转向；可见表演状态：表情由疑惑转为戒备，视线锁定关键道具，手部保持明确接触关系；必要连续性：人物身份、服装、道具材质、空间轴线和光向连续；只呈现当前时间点已经发生的静态结果，不表现运动过程。"
              },
              {
                "id": "SH001-F05",
                "sequenceIndex": 5,
                "startSecond": 12,
                "endSecond": 15,
                "actionPrompt": "落到结果、反应或转场：断口冷光成为匹配切入口；Karin在马车中猛然睁眼，手扣断剑，呼吸急促并完全惊醒",
                "imagePrompt": "静态关键帧：马车内Karin完全惊醒，灰绿色眼睛锁定断剑握柄，肩膀绷紧，手掌稳定扣住断剑；车厢冷光与暗影关系落定；可见状态：结果状态与转场落点已经成立，主体姿态和道具位置清晰；可见表演状态：表情由惊惧收束为警觉，视线稳定锁定断剑，肩膀绷紧；必要连续性：人物身份、服装、道具材质、空间轴线和光向连续；只呈现当前时间点已经发生的静态结果，不表现运动过程。"
              }
            ],
            "referenceManifest": [
              {
            ...
            "frames": [
              {
                ...
                "startSecond": 0,
                "endSecond": 3,
                "actionPrompt": "建立场景与动作入口：Rifa转向刚惊醒的Karin；Karin手仍扣住断剑，视线避开对方，车厢随车轮轻晃",
                "imagePrompt": "静态关键帧：马车内Rifa转向Karin，Karin手仍扣住断剑，眼睛刚从惊醒中收回，视线避开Rifa；可见状态：动作入口已成立，主体处于可辨识准备姿态；可见表演状态：眉眼骤然睁开、下颌绷紧，视线落向断剑，手部继续扣住握柄；必要连续性：人物身份、服装、道具材质、空间轴线和光向连续；只呈现当前时间点已经发生的静态结果，不表现运动过程。"
              },
              {
                "id": "SH002-F02",
                "sequenceIndex": 2,
                "startSecond": 3,
                "endSecond": 6,
                "actionPrompt": "镜头推进并改变主体状态：镜头向两人推进；Rifa抬眉等待回答，Karin短暂抬眼又移开，嘴角压住否认梦境",
                "imagePrompt": "静态关键帧：Rifa眉心微收看向Karin；Karin抬眼与她短暂对视后移开视线，嘴角压住，手指仍扣住断剑；可见状态：镜头推进后主体重心、视线或手部位置已经改变；可见表演状态：眉心轻收、嘴角压住，视线先避开对方后短暂回看，手部保持道具接触；必要连续性：人物身份、服装、道具材质、空间轴线和光向连续；只呈现当前时间点已经发生的静态结果，不表现运动过程。"
              },
              {
                "id": "SH002-F03",
                "sequenceIndex": 3,
                "startSecond": 6,
                "endSecond": 9,
                "actionPrompt": "镜头推进并改变主体状态：Rifa把水囊沿座椅推向Karin；Karin的视线跟随水囊，手从断剑旁抬起准备接住",
                "imagePrompt": "静态关键帧：水囊已经滑到Karin手边，Karin抬手接住，Rifa的目光停在他的手上，车窗冷光掠过座椅；可见状态：关键动作已经发生，道具或环境出现可见结果；可见表演状态：表情紧张略缓，视线跟随水囊，手部从待接变为握稳；必要连续性：人物身份、服装、道具材质、空间轴线和光向连续；只呈现当前时间点已经发生的静态结果，不表现运动过程。"
              },
              {
                "id": "SH002-F04",
                "sequenceIndex": 4,
                "startSecond": 9,
                "endSecond": 12,
                "actionPrompt": "执行关键动作：Karin接住水囊并缓下呼吸；腰间护符短促闪烁后熄灭，Rifa的目光转向护符",
                "imagePrompt": "静态关键帧：Karin双手握住水囊，肩膀略微放松；腰间护符刚熄灭，Rifa转头看向护符，车厢气氛重新收紧；可见状态：结果状态继续发展，主体反应或道具关系已经转向；可见表演状态：表情紧张略缓，视线跟随水囊，手部从待接变为握稳；必要连续性：人物身份、服装、道具材质、空间轴线和光向连续；只呈现当前时间点已经发生的静态结果，不表现运动过程。"
              },
              {
                "id": "SH002-F05",
                "sequenceIndex": 5,
                "startSecond": 12,
                "endSecond": 15,
                "actionPrompt": "落到结果、反应或转场：两人把视线落向逼近的皇家结界；Karin收回握水囊的手，Rifa停止追问，镜头落在车窗外的冷光",
                "imagePrompt": "静态关键帧：Karin握住水囊望向车窗外，Rifa也转向逼近的皇家结界；两人坐姿与道具位置落在克制的结果状态；可见状态：结果状态与转场落点已经成立，主体姿态和道具位置清晰；可见表演状态：表情紧张略缓，视线跟随水囊，手部从待接变为握稳；必要连续性：人物身份、服装、道具材质、空间轴线和光向连续；只呈现当前时间点已经发生的静态结果，不表现运动过程。"
              }
            ],
            "referenceManifest": [
              {
            ...
            "frames": [
              {
                ...
                "startSecond": 0,
                "endSecond": 3,
                "actionPrompt": "建立场景与动作入口：车窗外的结界冷光逼近马车；Karin低头看向正在熄灭的护符，Rifa转头确认他的反应",
                "imagePrompt": "静态关键帧：马车内Karin低头看向掌中的护符，护符只剩最后一点微光；Rifa在对面转头看他，车窗外结界冷光刚映上两人的脸；可见状态：动作入口已成立，主体处于可辨识准备姿态；可见表演状态：眉心收紧、眼神警觉，视线锁定结界或探测器，手部握紧当前道具；必要连续性：人物身份、服装、道具材质、空间轴线和光向连续；只呈现当前时间点已经发生的静态结果，不表现运动过程。"
              },
              {
                "id": "SH003-F02",
                "sequenceIndex": 2,
                "startSecond": 3,
                "endSecond": 6,
                "actionPrompt": "镜头推进并改变主体状态：结界光线扫过车厢；护符短促闪烁后熄灭，Karin抬头，Rifa的视线转向车窗外",
                "imagePrompt": "静态关键帧：护符已经熄灭，Karin抬头看向车窗，冷色结界纹理横过他的眼睛；Rifa侧身望向逼近的结界；可见状态：镜头推进后主体重心、视线或手部位置已经改变；可见表演状态：眉心收紧、眼神警觉，视线锁定结界或探测器，手部握紧当前道具；必要连续性：人物身份、服装、道具材质、空间轴线和光向连续；只呈现当前时间点已经发生的静态结果，不表现运动过程。"
              },
              {
                "id": "SH003-F03",
                "sequenceIndex": 3,
                "startSecond": 6,
                "endSecond": 9,
                "actionPrompt": "镜头推进并改变主体状态：Karin伸手重新握住失灵的护符；Rifa向车窗靠近，车厢座位随马车转弯轻晃",
                "imagePrompt": "静态关键帧：Karin五指收紧握住失灵护符，手腕停在胸前；Rifa已经靠近车窗，结界冷光切过她的侧脸；可见状态：关键动作已经发生，道具或环境出现可见结果；可见表演状态：眉心收紧、眼神警觉，视线锁定结界或探测器，手部握紧当前道具；必要连续性：人物身份、服装、道具材质、空间轴线和光向连续；只呈现当前时间点已经发生的静态结果，不表现运动过程。"
              },
              {
                "id": "SH003-F04",
                "sequenceIndex": 4,
                "startSecond": 9,
                "endSecond": 12,
                "actionPrompt": "执行关键动作：结界光在护符表面反射后彻底消失；Karin与Rifa同时把视线锁向车外，身体进入警戒姿态",
                "imagePrompt": "静态关键帧：护符表面没有光，冷色结界倒影占据车窗；Karin肩膀绷紧，Rifa前倾，两人的视线同时落向车外；可见状态：结果状态继续发展，主体反应或道具关系已经转向；可见表演状态：眉心收紧、眼神警觉，视线锁定结界或探测器，手部握紧当前道具；必要连续性：人物身份、服装、道具材质、空间轴线和光向连续；只呈现当前时间点已经发生的静态结果，不表现运动过程。"
              },
              {
                "id": "SH003-F05",
                "sequenceIndex": 5,
                "startSecond": 12,
                "endSecond": 15,
                "actionPrompt": "落到结果、反应或转场：马车驶入结界边缘；Karin扣住护符，Rifa望向结界深处，二人以警觉姿态迎接盘查",
                "imagePrompt": "静态关键帧：Karin扣住已经熄灭的护符，Rifa望向车窗外的结界入口；两人坐姿和视线落在明确的警戒终点；可见状态：结果状态与转场落点已经成立，主体姿态和道具位置清晰；可见表演状态：眉心收紧、眼神警觉，视线锁定结界或探测器，手部握紧当前道具；必要连续性：人物身份、服装、道具材质、空间轴线和光向连续；只呈现当前时间点已经发生的静态结果，不表现运动过程。"
              }
            ],
            "referenceManifest": [
              {
            ...
            "frames": [
              {
                ...
                "startSecond": 0,
                "endSecond": 3,
                "actionPrompt": "建立场景与动作入口：马车穿过结界薄膜；折射光掠过Karin与Rifa的脸，城门法师从远处转头",
                "imagePrompt": "静态关键帧：马车刚穿过半透明结界，冷光纹理横过Karin和Rifa的脸；城门法师在背景转头注视他们；可见状态：动作入口已成立，主体处于可辨识准备姿态；可见表演状态：眉心收紧、眼神警觉，视线锁定结界或探测器，手部握紧当前道具；必要连续性：人物身份、服装、道具材质、空间轴线和光向连续；只呈现当前时间点已经发生的静态结果，不表现运动过程。"
              },
              {
                "id": "SH004-F02",
                "sequenceIndex": 2,
                "startSecond": 3,
                "endSecond": 6,
                "actionPrompt": "镜头推进并改变主体状态：两人下车走到检查台前；检查官抬起黄铜探测器，对准Karin腰间的断剑",
                "imagePrompt": "静态关键帧：Karin与Rifa刚停在检查台前，检查官举起黄铜探测器对准Karin腰间断剑，法师仍在后方观察；可见状态：镜头推进后主体重心、视线或手部位置已经改变；可见表演状态：眉心收紧、眼神警觉，视线锁定结界或探测器，手部握紧当前道具；必要连续性：人物身份、服装、道具材质、空间轴线和光向连续；只呈现当前时间点已经发生的静态结果，不表现运动过程。"
              },
              {
                "id": "SH004-F03",
                "sequenceIndex": 3,
                "startSecond": 6,
                "endSecond": 9,
                "actionPrompt": "镜头推进并改变主体状态：探测器指针从零位抬起又回落；Karin收住脚步，Rifa把视线从检查官移向指针",
                "imagePrompt": "静态关键帧：黄铜探测器已经靠近断剑，指针停在零位；Karin站在台前收住脚步，Rifa侧眼看向空白刻度；可见状态：关键动作已经发生，道具或环境出现可见结果；可见表演状态：眉心收紧、眼神警觉，视线锁定结界或探测器，手部握紧当前道具；必要连续性：人物身份、服装、道具材质、空间轴线和光向连续；只呈现当前时间点已经发生的静态结果，不表现运动过程。"
              },
              {
                "id": "SH004-F04",
                "sequenceIndex": 4,
                "startSecond": 9,
                "endSecond": 12,
                "actionPrompt": "执行关键动作：检查官把探测器转向Rifa；Karin与Rifa短暂交换视线，三人的站位被检查台拉开",
                "imagePrompt": "静态关键帧：探测器转向Rifa，Karin回头与她短暂对视；检查官横在两人和城门之间，检查台形成清晰前景；可见状态：结果状态继续发展，主体反应或道具关系已经转向；可见表演状态：眉心收紧、眼神警觉，视线锁定结界或探测器，手部握紧当前道具；必要连续性：人物身份、服装、道具材质、空间轴线和光向连续；只呈现当前时间点已经发生的静态结果，不表现运动过程。"
              },
              {
                "id": "SH004-F05",
                "sequenceIndex": 5,
                "startSecond": 12,
                "endSecond": 15,
                "actionPrompt": "落到结果、反应或转场：探测器完全举在两人之间并保持零读数；法师的注视落定，二人停在检查台前等待放行",
                "imagePrompt": "静态关键帧：黄铜探测器停在两人之间，指针仍指向零；Karin和Rifa站在检查台前，背景法师的目光已经锁定他们；可见状态：结果状态与转场落点已经成立，主体姿态和道具位置清晰；可见表演状态：眉心收紧、眼神警觉，视线锁定结界或探测器，手部握紧当前道具；必要连续性：人物身份、服装、道具材质、空间轴线和光向连续；只呈现当前时间点已经发生的静态结果，不表现运动过程。"
              }
            ],
            "referenceManifest": [
              {
            ...
            "frames": [
              {
                ...
                "startSecond": 0,
                "endSecond": 3,
                "actionPrompt": "建立场景与动作入口：探测器屏幕保持空白；检查官的手停在读数上方，Karin与Rifa看向同一块空白刻度",
                "imagePrompt": "静态关键帧：黄铜探测器的刻度盘完全空白，检查官手指停在盘面上方；Karin和Rifa的视线同时落向空白读数；可见状态：动作入口已成立，主体处于可辨识准备姿态；可见表演状态：眉心收紧、眼神警觉，视线锁定结界或探测器，手部握紧当前道具；必要连续性：人物身份、服装、道具材质、空间轴线和光向连续；只呈现当前时间点已经发生的静态结果，不表现运动过程。"
              },
              {
                "id": "SH005-F02",
                "sequenceIndex": 2,
                "startSecond": 3,
                "endSecond": 6,
                "actionPrompt": "镜头推进并改变主体状态：锁链从闸门上方开始下落；Karin抬眼看向闸门，Rifa向后撤开半步",
                "imagePrompt": "静态关键帧：闸门锁链刚从高处垂下，Karin抬头看向锁链，Rifa已经退到他的后侧，空白探测器仍在前景；可见状态：镜头推进后主体重心、视线或手部位置已经改变；可见表演状态：眉眼出现反应，视线转向当前目标，手部或道具位置相对入口发生变化；必要连续性：人物身份、服装、道具材质、空间轴线和光向连续；只呈现当前时间点已经发生的静态结果，不表现运动过程。"
              },
              {
                "id": "SH005-F03",
                "sequenceIndex": 3,
                "startSecond": 6,
                "endSecond": 9,
                "actionPrompt": "镜头推进并改变主体状态：Karin向前迈出半步挡在Rifa前面；检查官收回探测器，闸门继续下降",
                "imagePrompt": "静态关键帧：Karin已经前移半步挡在Rifa身前，肩线切开两人距离；检查官收回探测器，沉重闸门压低在背景；可见状态：关键动作已经发生，道具或环境出现可见结果；可见表演状态：眉心收紧、眼神警觉，视线锁定结界或探测器，手部握紧当前道具；必要连续性：人物身份、服装、道具材质、空间轴线和光向连续；只呈现当前时间点已经发生的静态结果，不表现运动过程。"
              },
              {
                "id": "SH005-F04",
                "sequenceIndex": 4,
                "startSecond": 9,
                "endSecond": 12,
                "actionPrompt": "执行关键动作：锁链绷直，闸门落到闭合位置；Rifa侧身避开，Karin的手移向腰后断剑",
                "imagePrompt": "静态关键帧：闸门已经完全闭合，锁链绷直；Rifa侧后站位，Karin的手停在腰后断剑附近，三人被封在同一侧；可见状态：结果状态继续发展，主体反应或道具关系已经转向；可见表演状态：眉心轻收、嘴角压住，视线先避开对方后短暂回看，手部保持道具接触；必要连续性：人物身份、服装、道具材质、空间轴线和光向连续；只呈现当前时间点已经发生的静态结果，不表现运动过程。"
              },
              {
                "id": "SH005-F05",
                "sequenceIndex": 5,
                "startSecond": 12,
                "endSecond": 15,
                "actionPrompt": "落到结果、反应或转场：空白读数映在闸门金属上；Karin挡在前方，Rifa保持侧后，盘查现场落入封锁结果",
                "imagePrompt": "静态关键帧：闸门金属反射出空白探测器刻度，Karin站在前方护住Rifa，锁链和检查台把封锁结果固定在画面中；可见状态：结果状态与转场落点已经成立，主体姿态和道具位置清晰；可见表演状态：表情、视线与手部关系落在动作结果，目标道具位置清晰；必要连续性：人物身份、服装、道具材质、空间轴线和光向连续；只呈现当前时间点已经发生的静态结果，不表现运动过程。"
              }
            ],
            "referenceManifest": [
              {
            ...
            "frames": [
              {
                ...
                "startSecond": 0,
                "endSecond": 3,
                "actionPrompt": "建立场景与动作入口：Karin拇指轻敲断剑护手发出旧信号；Rifa从侧后看见信号，双手仍垂在身侧",
                "imagePrompt": "静态关键帧：Karin拇指停在断剑护手上，敲击刚结束；Rifa在侧后抬眼确认，两人的手与断剑形成明确信号关系；可见状态：动作入口已成立，主体处于可辨识准备姿态；可见表演状态：表情与视线落在动作入口，手部与道具形成明确起点关系；必要连续性：人物身份、服装、道具材质、空间轴线和光向连续；只呈现当前时间点已经发生的静态结果，不表现运动过程。"
              },
              {
                "id": "SH006-F02",
                "sequenceIndex": 2,
                "startSecond": 3,
                "endSecond": 6,
                "actionPrompt": "镜头推进并改变主体状态：Rifa回敲同一节奏；两人同时转正肩线，手臂抬向尚未打开的封印线",
                "imagePrompt": "静态关键帧：Karin与Rifa的肩线已经对齐，两只手分别抬到封印线两侧；Rifa刚完成回敲，目光与Karin相接；可见状态：镜头推进后主体重心、视线或手部位置已经改变；可见表演状态：下颌收紧后放松，视线正对目标，手部由蓄力转为稳定收力；必要连续性：人物身份、服装、道具材质、空间轴线和光向连续；只呈现当前时间点已经发生的静态结果，不表现运动过程。"
              },
              {
                "id": "SH006-F03",
                "sequenceIndex": 3,
                "startSecond": 6,
                "endSecond": 9,
                "actionPrompt": "镜头推进并改变主体状态：两人同时把力量压入封印；银色细线从闸门缝隙亮起，尘埃被压力托离地面",
                "imagePrompt": "静态关键帧：闸门缝隙出现一条银色亮线，Karin和Rifa的手掌朝向封印；地面尘埃悬起，力量刚进入可见结果；可见状态：关键动作已经发生，道具或环境出现可见结果；可见表演状态：下颌收紧后放松，视线正对目标，手部由蓄力转为稳定收力；必要连续性：人物身份、服装、道具材质、空间轴线和光向连续；只呈现当前时间点已经发生的静态结果，不表现运动过程。"
              },
              {
                "id": "SH006-F04",
                "sequenceIndex": 4,
                "startSecond": 9,
                "endSecond": 12,
                "actionPrompt": "执行关键动作：封印向内凹陷，旗帜与衣角在无声压力中停住；两人手臂绷紧后开始收力",
                "imagePrompt": "静态关键帧：封印线向两人之间凹陷，悬停尘埃和停住的旗帜占据背景；Karin与Rifa手臂绷紧，表情从用力转向克制；可见状态：结果状态继续发展，主体反应或道具关系已经转向；可见表演状态：下颌收紧后放松，视线正对目标，手部由蓄力转为稳定收力；必要连续性：人物身份、服装、道具材质、空间轴线和光向连续；只呈现当前时间点已经发生的静态结果，不表现运动过程。"
              },
              {
                "id": "SH006-F05",
                "sequenceIndex": 5,
                "startSecond": 12,
                "endSecond": 15,
                "actionPrompt": "落到结果、反应或转场：两人完全并肩站定，只保留一线未开的封印；Karin与Rifa同时看向闸门缝隙，旧信号动作落到结果",
                "imagePrompt": "静态关键帧：Karin与Rifa肩并肩站在封印前，银线停在即将打开的位置；两人的视线共同落向缝隙，断剑和手部关系清晰；可见状态：结果状态与转场落点已经成立，主体姿态和道具位置清晰；可见表演状态：下颌收紧后放松，视线正对目标，手部由蓄力转为稳定收力；必要连续性：人物身份、服装、道具材质、空间轴线和光向连续；只呈现当前时间点已经发生的静态结果，不表现运动过程。"
              }
            ],
            "referenceManifest": [
              {
            ...
            "frames": [
              {
                ...
                "startSecond": 0,
                "endSecond": 3,
                "actionPrompt": "建立场景与动作入口：封印压力扩散；旗帜、尘埃和探测器指针同时停住，世界短暂失去惯性",
                "imagePrompt": "静态关键帧：城门前旗帜悬停在半空，尘埃凝住，黄铜探测器指针停在裂开的刻度上；Karin与Rifa站在冻结的空间中心；可见状态：动作入口已成立，主体处于可辨识准备姿态；可见表演状态：眉心收紧、眼神警觉，视线锁定结界或探测器，手部握紧当前道具；必要连续性：人物身份、服装、道具材质、空间轴线和光向连续；只呈现当前时间点已经发生的静态结果，不表现运动过程。"
              },
              {
                "id": "SH007-F02",
                "sequenceIndex": 2,
                "startSecond": 3,
                "endSecond": 6,
                "actionPrompt": "镜头推进并改变主体状态：闸门周围的结界向两人凹陷；Karin与Rifa保持伸手姿态，远处高塔观察者转身看向异常",
                "imagePrompt": "静态关键帧：结界像被无形力量压向Karin与Rifa，二人手臂仍伸向封印；高塔远处的观察者转身，银戒反射冷光；可见状态：镜头推进后主体重心、视线或手部位置已经改变；可见表演状态：眉心收紧、眼神警觉，视线锁定结界或探测器，手部握紧当前道具；必要连续性：人物身份、服装、道具材质、空间轴线和光向连续；只呈现当前时间点已经发生的静态结果，不表现运动过程。"
              },
              {
                "id": "SH007-F03",
                "sequenceIndex": 3,
                "startSecond": 6,
                "endSecond": 9,
                "actionPrompt": "镜头推进并改变主体状态：封印裂开一道可通行的银白缝隙；两人的力量达到峰值，闸门链条从内部断开",
                "imagePrompt": "静态关键帧：闸门中央出现银白缝隙，断开的链条垂落两侧；Karin与Rifa的手掌停在力量峰值，冷光照亮地面；可见状态：关键动作已经发生，道具或环境出现可见结果；可见表演状态：下颌收紧后放松，视线正对目标，手部由蓄力转为稳定收力；必要连续性：人物身份、服装、道具材质、空间轴线和光向连续；只呈现当前时间点已经发生的静态结果，不表现运动过程。"
              },
              {
                "id": "SH007-F04",
                "sequenceIndex": 4,
                "startSecond": 9,
                "endSecond": 12,
                "actionPrompt": "执行关键动作：Karin先收回力量，Rifa慢半拍跟上；两人重新踩稳，闸门在身后开始打开",
                "imagePrompt": "静态关键帧：Karin已经收回手臂并站稳，Rifa正从蓄力姿态放下手；闸门向两侧打开，地面尘埃重新落下；可见状态：结果状态继续发展，主体反应或道具关系已经转向；可见表演状态：下颌收紧后放松，视线正对目标，手部由蓄力转为稳定收力；必要连续性：人物身份、服装、道具材质、空间轴线和光向连续；只呈现当前时间点已经发生的静态结果，不表现运动过程。"
              },
              {
                "id": "SH007-F05",
                "sequenceIndex": 5,
                "startSecond": 12,
                "endSecond": 15,
                "actionPrompt": "落到结果、反应或转场：闸门完全打开；Karin与Rifa并肩站定，远处观察者隔着城市纵深继续注视",
                "imagePrompt": "静态关键帧：打开的闸门形成前景框景，Karin与Rifa站在城门内侧，远处高塔上的观察者仍望向他们，结果关系固定；可见状态：结果状态与转场落点已经成立，主体姿态和道具位置清晰；可见表演状态：眉心收紧、眼神警觉，视线锁定结界或探测器，手部握紧当前道具；必要连续性：人物身份、服装、道具材质、空间轴线和光向连续；只呈现当前时间点已经发生的静态结果，不表现运动过程。"
              }
            ],
            "referenceManifest": [
              {
            ...
            "frames": [
              {
                ...
                "startSecond": 0,
                "endSecond": 3,
                "actionPrompt": "建立场景与动作入口：城市沿陡坡在两人面前展开；Karin抬头寻找上行道路，Rifa与他并肩走在同一动线上",
                "imagePrompt": "静态关键帧：阿佐雷斯城市沿陡坡向上叠起，Karin仰头看向高处道路，Rifa在他身侧并肩前行，断剑贴在腰后；可见状态：动作入口已成立，主体处于可辨识准备姿态；可见表演状态：表情与视线落在动作入口，手部与道具形成明确起点关系；必要连续性：人物身份、服装、道具材质、空间轴线和光向连续；只呈现当前时间点已经发生的静态结果，不表现运动过程。"
              },
              {
                "id": "SH008-F02",
                "sequenceIndex": 2,
                "startSecond": 3,
                "endSecond": 6,
                "actionPrompt": "镜头推进并改变主体状态：断剑撞上路边手推车；Karin立刻伸手护住剑鞘，Rifa停下半步看向他的手",
                "imagePrompt": "静态关键帧：手推车刚被断剑碰到，Karin的手已经压住剑鞘，木轮停在前景；Rifa侧身看向他的手，城市坡道延向背景；可见状态：镜头推进后主体重心、视线或手部位置已经改变；可见表演状态：眉眼出现反应，视线转向当前目标，手部或道具位置相对入口发生变化；必要连续性：人物身份、服装、道具材质、空间轴线和光向连续；只呈现当前时间点已经发生的静态结果，不表现运动过程。"
              },
              {
                "id": "SH008-F03",
                "sequenceIndex": 3,
                "startSecond": 6,
                "endSecond": 9,
                "actionPrompt": "镜头推进并改变主体状态：Rifa放慢脚步与Karin对齐；她的视线从断剑移到Karin脸上，Karin把目光留在坡道前方",
                "imagePrompt": "静态关键帧：Rifa已经放慢并与Karin肩线对齐，目光落在他的脸上；Karin仍望向坡道上方，手没有离开剑鞘；可见状态：关键动作已经发生，道具或环境出现可见结果；可见表演状态：眉眼出现反应，视线转向当前目标，手部或道具位置相对入口发生变化；必要连续性：人物身份、服装、道具材质、空间轴线和光向连续；只呈现当前时间点已经发生的静态结果，不表现运动过程。"
              },
              {
                "id": "SH008-F04",
                "sequenceIndex": 4,
                "startSecond": 9,
                "endSecond": 12,
                "actionPrompt": "执行关键动作：Karin的手从剑鞘边缘稍微松开又重新扣住；Rifa侧头等待回答，两人的步伐在坡道转折处停顿",
                "imagePrompt": "静态关键帧：坡道转折处，Karin手指从剑鞘边缘短暂松开又扣回；Rifa侧头看他，两人的脚步刚停在同一台阶；可见状态：结果状态继续发展，主体反应或道具关系已经转向；可见表演状态：眉眼出现反应，视线转向当前目标，手部或道具位置相对入口发生变化；必要连续性：人物身份、服装、道具材质、空间轴线和光向连续；只呈现当前时间点已经发生的静态结果，不表现运动过程。"
              },
              {
                "id": "SH008-F05",
                "sequenceIndex": 5,
                "startSecond": 12,
                "endSecond": 15,
                "actionPrompt": "落到结果、反应或转场：两人重新并肩走到上行坡道尽头；Karin避开Rifa的视线，Rifa把目光投向前方门口",
                "imagePrompt": "静态关键帧：Karin与Rifa并肩抵达上行坡道尽头，Karin视线避开她，Rifa望向前方门口；断剑位置和两人站位落定；可见状态：结果状态与转场落点已经成立，主体姿态和道具位置清晰；可见表演状态：眉心轻收、嘴角压住，视线先避开对方后短暂回看，手部保持道具接触；必要连续性：人物身份、服装、道具材质、空间轴线和光向连续；只呈现当前时间点已经发生的静态结果，不表现运动过程。"
              }
            ],
            "referenceManifest": [
              {
            ...
            "frames": [
              {
                ...
                "startSecond": 0,
                "endSecond": 3,
                "actionPrompt": "建立场景与动作入口：Edia Knight木门上的银色裂痕映入Karin眼中；他停在门外，手指靠近腰后断剑",
                "imagePrompt": "静态关键帧：木门上的银色裂痕占据前景，纹路与梦中断口相同；Karin停在门外看向裂痕，手指悬在腰后断剑旁；可见状态：动作入口已成立，主体处于可辨识准备姿态；可见表演状态：表情与视线落在动作入口，手部与道具形成明确起点关系；必要连续性：人物身份、服装、道具材质、空间轴线和光向连续；只呈现当前时间点已经发生的静态结果，不表现运动过程。"
              },
              {
                "id": "SH009-F02",
                "sequenceIndex": 2,
                "startSecond": 3,
                "endSecond": 6,
                "actionPrompt": "镜头推进并改变主体状态：木门向内打开；Karin与Rifa停在门槛，奥伦背对站在炉光深处",
                "imagePrompt": "静态关键帧：木门已经打开一半，Karin与Rifa停在门槛外；奥伦背对他们立在暗琥珀炉光与银纹冷光交界处；可见状态：镜头推进后主体重心、视线或手部位置已经改变；可见表演状态：眉眼出现反应，视线转向当前目标，手部或道具位置相对入口发生变化；必要连续性：人物身份、服装、道具材质、空间轴线和光向连续；只呈现当前时间点已经发生的静态结果，不表现运动过程。"
              },
              {
                "id": "SH009-F03",
                "sequenceIndex": 3,
                "startSecond": 6,
                "endSecond": 9,
                "actionPrompt": "镜头推进并改变主体状态：Karin把靠近断剑的手收回衣侧；Rifa向门内探看，奥伦仍不回头，三人的纵深开始拉开",
                "imagePrompt": "静态关键帧：Karin的手已经收回衣侧，身体略向后收；Rifa向门内探看，奥伦背对站在铁砧前，门框分隔三人；可见状态：关键动作已经发生，道具或环境出现可见结果；可见表演状态：眉眼出现反应，视线转向当前目标，手部或道具位置相对入口发生变化；必要连续性：人物身份、服装、道具材质、空间轴线和光向连续；只呈现当前时间点已经发生的静态结果，不表现运动过程。"
              },
              {
                "id": "SH009-F04",
                "sequenceIndex": 4,
                "startSecond": 9,
                "endSecond": 12,
                "actionPrompt": "执行关键动作：Rifa转头确认Karin的反应；Karin避开她的视线，把梦境藏回沉默，奥伦的肩膀微微转动",
                "imagePrompt": "静态关键帧：Rifa侧头看向Karin，Karin把脸转向门内避开目光；奥伦肩膀刚开始转动，炉光压在他的背上；可见状态：结果状态继续发展，主体反应或道具关系已经转向；可见表演状态：眉心轻收、嘴角压住，视线先避开对方后短暂回看，手部保持道具接触；必要连续性：人物身份、服装、道具材质、空间轴线和光向连续；只呈现当前时间点已经发生的静态结果，不表现运动过程。"
              },
              {
                "id": "SH009-F05",
                "sequenceIndex": 5,
                "startSecond": 12,
                "endSecond": 15,
                "actionPrompt": "落到结果、反应或转场：三人停在门槛关系中；奥伦背对门内，Karin与Rifa并立门外，银纹冷光与炉火形成明确分界",
                "imagePrompt": "静态关键帧：Karin与Rifa并立在门槛外，奥伦背对站在炉火深处；门上银纹冷光和室内炉光把三人的空间关系固定；可见状态：结果状态与转场落点已经成立，主体姿态和道具位置清晰；可见表演状态：表情、视线与手部关系落在动作结果，目标道具位置清晰；必要连续性：人物身份、服装、道具材质、空间轴线和光向连续；只呈现当前时间点已经发生的静态结果，不表现运动过程。"
              }
            ],
            "referenceManifest": [
              {
            ...
            "frames": [
              {
                ...
                "startSecond": 0,
                "endSecond": 3,
                "actionPrompt": "建立场景与动作入口：奥伦从铁砧旁抬眼质疑断剑为何被打断；Karin站在铁砧前，Rifa留在门侧观察",
                "imagePrompt": "静态关键帧：奥伦抬眼看向Karin和腰后断剑，铁砧占据前景；Karin站在铁砧前，Rifa在门侧保持旁观位置；可见状态：动作入口已成立，主体处于可辨识准备姿态；可见表演状态：表情由疑惑转为戒备，视线锁定关键道具，手部保持明确接触关系；必要连续性：人物身份、服装、道具材质、空间轴线和光向连续；只呈现当前时间点已经发生的静态结果，不表现运动过程。"
              },
              {
                "id": "SH010-F02",
                "sequenceIndex": 2,
                "startSecond": 3,
                "endSecond": 6,
                "actionPrompt": "镜头推进并改变主体状态：Karin取下断剑平放到铁砧上；Rifa的视线跟随剑身，奥伦伸手取来无头锤柄",
                "imagePrompt": "静态关键帧：断剑已经平放在铁砧中央，Karin的手刚离开剑柄；Rifa看向剑身，奥伦从铁砧旁拿起无头锤柄；可见状态：镜头推进后主体重心、视线或手部位置已经改变；可见表演状态：表情由疑惑转为戒备，视线锁定关键道具，手部保持明确接触关系；必要连续性：人物身份、服装、道具材质、空间轴线和光向连续；只呈现当前时间点已经发生的静态结果，不表现运动过程。"
              },
              {
                "id": "SH010-F03",
                "sequenceIndex": 3,
                "startSecond": 6,
                "endSecond": 9,
                "actionPrompt": "镜头推进并改变主体状态：奥伦把锤柄缓缓对准断口；Karin收紧手指但没有阻止，Rifa向门侧退开半步",
                "imagePrompt": "静态关键帧：无头锤柄已经抵住断剑断口，奥伦的手压在上方；Karin手指收紧，Rifa退到门侧，三层站位清晰；可见状态：关键动作已经发生，道具或环境出现可见结果；可见表演状态：表情由疑惑转为戒备，视线锁定关键道具，手部保持明确接触关系；必要连续性：人物身份、服装、道具材质、空间轴线和光向连续；只呈现当前时间点已经发生的静态结果，不表现运动过程。"
              },
              {
                "id": "SH010-F04",
                "sequenceIndex": 4,
                "startSecond": 9,
                "endSecond": 12,
                "actionPrompt": "执行关键动作：锤柄触碰断口，炉火收成一线；Karin抬头看向奥伦，断剑裂痕映出冷银光",
                "imagePrompt": "静态关键帧：锤柄刚触到断口，炉火缩成铁砧旁的一线暗光；Karin抬头看奥伦，裂痕在冷银反光中清晰可见；可见状态：结果状态继续发展，主体反应或道具关系已经转向；可见表演状态：表情由疑惑转为戒备，视线锁定关键道具，手部保持明确接触关系；必要连续性：人物身份、服装、道具材质、空间轴线和光向连续；只呈现当前时间点已经发生的静态结果，不表现运动过程。"
              },
              {
                "id": "SH010-F05",
                "sequenceIndex": 5,
                "startSecond": 12,
                "endSecond": 15,
                "actionPrompt": "落到结果、反应或转场：锤柄停在断口上，三人不再移动；奥伦的手、Karin的断剑和Rifa的视线共同落到被打断的结果",
                "imagePrompt": "静态关键帧：无头锤柄稳定抵在断剑断口，Karin站在铁砧前，奥伦的手没有移开，Rifa从门侧注视断口，结果状态成立；可见状态：结果状态与转场落点已经成立，主体姿态和道具位置清晰；可见表演状态：表情由疑惑转为戒备，视线锁定关键道具，手部保持明确接触关系；必要连续性：人物身份、服装、道具材质、空间轴线和光向连续；只呈现当前时间点已经发生的静态结果，不表现运动过程。"
              }
            ],
            "referenceManifest": [
              {
            ...
            "frames": [
              {
                ...
                "startSecond": 0,
                "endSecond": 3,
                "actionPrompt": "建立场景与动作入口：断剑旁的记忆残影显出一条暗红线；Karin低头看向自己的手腕，Rifa发现线条与她的辫绳相似",
                "imagePrompt": "静态关键帧：炉火收缩后的铁砧旁，Karin手腕上浮出暗红线残影；Rifa看向那条线，奥伦停在冷光边缘；可见状态：动作入口已成立，主体处于可辨识准备姿态；可见表演状态：表情与视线落在动作入口，手部与道具形成明确起点关系；必要连续性：人物身份、服装、道具材质、空间轴线和光向连续；只呈现当前时间点已经发生的静态结果，不表现运动过程。"
              },
              {
                "id": "SH011-F02",
                "sequenceIndex": 2,
                "startSecond": 3,
                "endSecond": 6,
                "actionPrompt": "镜头推进并改变主体状态：暗红线沿Karin手腕向断剑延伸；Karin想把手收回，Rifa抬手阻止他的动作",
                "imagePrompt": "静态关键帧：暗红线已经连接到Karin握剑的手腕，Karin正要收手；Rifa的手悬在他腕前，奥伦的目光落向两只手；可见状态：镜头推进后主体重心、视线或手部位置已经改变；可见表演状态：眉眼出现反应，视线转向当前目标，手部或道具位置相对入口发生变化；必要连续性：人物身份、服装、道具材质、空间轴线和光向连续；只呈现当前时间点已经发生的静态结果，不表现运动过程。"
              },
              {
                "id": "SH011-F03",
                "sequenceIndex": 3,
                "startSecond": 6,
                "endSecond": 9,
                "actionPrompt": "镜头推进并改变主体状态：Rifa抓住Karin手腕；她的辫绳与记忆中的红线重合，奥伦向前半步确认相接的手",
                "imagePrompt": "静态关键帧：Rifa已经扣住Karin手腕，暗红辫绳与腕上红线并列；奥伦向前半步，视线集中在两人相接的手；可见状态：关键动作已经发生，道具或环境出现可见结果；可见表演状态：眉眼出现反应，视线转向当前目标，手部或道具位置相对入口发生变化；必要连续性：人物身份、服装、道具材质、空间轴线和光向连续；只呈现当前时间点已经发生的静态结果，不表现运动过程。"
              },
              {
                "id": "SH011-F04",
                "sequenceIndex": 4,
                "startSecond": 9,
                "endSecond": 12,
                "actionPrompt": "执行关键动作：Karin的手腕在Rifa掌中绷紧又停住；Rifa没有松手，奥伦的手停在断剑上方",
                "imagePrompt": "静态关键帧：Karin手腕在Rifa掌中绷紧，手指停在断剑旁；Rifa牢牢扣住他，奥伦的手悬在断剑上方，三点关系形成；可见状态：结果状态继续发展，主体反应或道具关系已经转向；可见表演状态：眉眼出现反应，视线转向当前目标，手部或道具位置相对入口发生变化；必要连续性：人物身份、服装、道具材质、空间轴线和光向连续；只呈现当前时间点已经发生的静态结果，不表现运动过程。"
              },
              {
                "id": "SH011-F05",
                "sequenceIndex": 5,
                "startSecond": 12,
                "endSecond": 15,
                "actionPrompt": "落到结果、反应或转场：暗红线与辫绳同时落入冷光；Rifa仍抓住Karin，奥伦注视相接的手，记忆结果切回现实",
                "imagePrompt": "静态关键帧：冷光压过炉火，Rifa的手仍扣住Karin腕部，奥伦俯视两人相接的手；暗红线和辫绳形成清晰的记忆回声；可见状态：结果状态与转场落点已经成立，主体姿态和道具位置清晰；可见表演状态：眉心收紧、眼神警觉，视线锁定结界或探测器，手部握紧当前道具；必要连续性：人物身份、服装、道具材质、空间轴线和光向连续；只呈现当前时间点已经发生的静态结果，不表现运动过程。"
              }
            ],
            "referenceManifest": [
              {
            ...
            "frames": [
              {
                ...
                "startSecond": 0,
                "endSecond": 3,
                "actionPrompt": "建立场景与动作入口：奥伦的解释停在半句；窄木匣从铁砧下被推到前景，Karin与Rifa同时把视线移向匣面",
                "imagePrompt": "静态关键帧：窄木匣已经停在铁砧边，Karin和Rifa的视线从奥伦转向匣面；奥伦的手留在匣盖旁，炉火压低；可见状态：动作入口已成立，主体处于可辨识准备姿态；可见表演状态：表情由疑惑转为戒备，视线锁定关键道具，手部保持明确接触关系；必要连续性：人物身份、服装、道具材质、空间轴线和光向连续；只呈现当前时间点已经发生的静态结果，不表现运动过程。"
              },
              {
                "id": "SH012-F02",
                "sequenceIndex": 2,
                "startSecond": 3,
                "endSecond": 6,
                "actionPrompt": "镜头推进并改变主体状态：木匣盖弹开，四个微光点依次亮起；Rifa的手靠近短刃，Karin盯住匣内的冷光",
                "imagePrompt": "静态关键帧：木匣盖已经打开，四个微光点在黑色内衬上亮起；Rifa手指靠近短刃柄，Karin俯身看向匣内；可见状态：镜头推进后主体重心、视线或手部位置已经改变；可见表演状态：表情由疑惑转为戒备，视线锁定关键道具，手部保持明确接触关系；必要连续性：人物身份、服装、道具材质、空间轴线和光向连续；只呈现当前时间点已经发生的静态结果，不表现运动过程。"
              },
              {
                "id": "SH012-F03",
                "sequenceIndex": 3,
                "startSecond": 6,
                "endSecond": 9,
                "actionPrompt": "镜头推进并改变主体状态：烟黑铜镜在匣内反射出高塔观察者；Karin抬头，Rifa转向镜面，奥伦的手停在熄灭的炉膛旁",
                "imagePrompt": "静态关键帧：烟黑铜镜已经映出高塔观察者的轮廓，Karin与Rifa同时转向镜面；奥伦停在暗下来的炉膛旁；可见状态：关键动作已经发生，道具或环境出现可见结果；可见表演状态：表情由疑惑转为戒备，视线锁定关键道具，手部保持明确接触关系；必要连续性：人物身份、服装、道具材质、空间轴线和光向连续；只呈现当前时间点已经发生的静态结果，不表现运动过程。"
              },
              {
                "id": "SH012-F04",
                "sequenceIndex": 4,
                "startSecond": 9,
                "endSecond": 12,
                "actionPrompt": "执行关键动作：炉火完全熄灭，铜镜中的观察者保持清晰；短刃从鞘中滑出半寸，三人的视线被镜面分开",
                "imagePrompt": "静态关键帧：炉火已经熄灭，铜镜仍映着高塔观察者；短刃露出半寸停在匣边，Karin、Rifa和奥伦的视线分别落向镜面与刀口；可见状态：结果状态继续发展，主体反应或道具关系已经转向；可见表演状态：表情由疑惑转为戒备，视线锁定关键道具，手部保持明确接触关系；必要连续性：人物身份、服装、道具材质、空间轴线和光向连续；只呈现当前时间点已经发生的静态结果，不表现运动过程。"
              },
              {
                "id": "SH012-F05",
                "sequenceIndex": 5,
                "startSecond": 12,
                "endSecond": 15,
                "actionPrompt": "落到结果、反应或转场：木匣四点微光、铜镜观察者和半出鞘短刃同时落入静止终点；答案结束，新问题被留下",
                "imagePrompt": "静态关键帧：暗室中木匣四点微亮，铜镜映着高塔观察者，短刃出鞘半寸；Karin与Rifa停在匣前，奥伦留在熄灭炉膛旁；可见状态：结果状态与转场落点已经成立，主体姿态和道具位置清晰；可见表演状态：表情由疑惑转为戒备，视线锁定关键道具，手部保持明确接触关系；必要连续性：人物身份、服装、道具材质、空间轴线和光向连续；只呈现当前时间点已经发生的静态结果，不表现运动过程。"
              }
            ],
            "referenceManifest": [
              {
  ...
  "archive": {
    ...
    "sections": [
      ...
      },
      {
        ...
        "content": "默认每镜 5 个连续剧情帧；用户可在 1-9 帧范围内明确调整。\n\n### SH001 黑湖记忆\n- P01-F01 0-3s：建立场景与动作入口：黑湖与倒悬古塔建立空间；Karin低头，完整剑刃贴在掌心，四只手刚刚扣住\n- P01-F02 3-6s：镜头推进并改变主体状态：镜头向雪地与四只手推进；Karin抬头看向倒悬古塔，双手收紧，完整剑刃出现第一道银色裂纹\n- P01-F03 6-9s：镜头推进并改变主体状态：剑刃从掌心断口向外裂开，冷银碎屑飞出；Karin眉眼骤然睁大，下颌绷紧，四只手仍扣住断剑\n- P01-F04 9-12s：执行关键动作：裂纹扩展成断口，镜头落到冷银碎片；Karin手指仍扣住剑刃，视线从断口转向无法解释的裂痕\n- P01-F05 12-15s：落到结果、反应或转场：断口冷光成为匹配切入口；Karin在马车中猛然睁眼，手扣断剑，呼吸急促并完全惊醒\n\n### SH002 梦醒试探\n- P02-F01 0-3s：建立场景与动作入口：Rifa转向刚惊醒的Karin；Karin手仍扣住断剑，视线避开对方，车厢随车轮轻晃\n- P02-F02 3-6s：镜头推进并改变主体状态：镜头向两人推进；Rifa抬眉等待回答，Karin短暂抬眼又移开，嘴角压住否认梦境\n- P02-F03 6-9s：镜头推进并改变主体状态：Rifa把水囊沿座椅推向Karin；Karin的视线跟随水囊，手从断剑旁抬起准备接住\n- P02-F04 9-12s：执行关键动作：Karin接住水囊并缓下呼吸；腰间护符短促闪烁后熄灭，Rifa的目光转向护符\n- P02-F05 12-15s：落到结果、反应或转场：两人把视线落向逼近的皇家结界；Karin收回握水囊的手，Rifa停止追问，镜头落在车窗外的冷光\n\n### SH003 第几个\n- P03-F01 0-3s：建立场景与动作入口：车窗外的结界冷光逼近马车；Karin低头看向正在熄灭的护符，Rifa转头确认他的反应\n- P03-F02 3-6s：镜头推进并改变主体状态：结界光线扫过车厢；护符短促闪烁后熄灭，Karin抬头，Rifa的视线转向车窗外\n- P03-F03 6-9s：镜头推进并改变主体状态：Karin伸手重新握住失灵的护符；Rifa向车窗靠近，车厢座位随马车转弯轻晃\n- P03-F04 9-12s：执行关键动作：结界光在护符表面反射后彻底消失；Karin与Rifa同时把视线锁向车外，身体进入警戒姿态\n- P03-F05 12-15s：落到结果、反应或转场：马车驶入结界边缘；Karin扣住护符，Rifa望向结界深处，二人以警觉姿态迎接盘查\n\n### SH004 跨越结界\n- P04-F01 0-3s：建立场景与动作入口：马车穿过结界薄膜；折射光掠过Karin与Rifa的脸，城门法师从远处转头\n- P04-F02 3-6s：镜头推进并改变主体状态：两人下车走到检查台前；检查官抬起黄铜探测器，对准Karin腰间的断剑\n- P04-F03 6-9s：镜头推进并改变主体状态：探测器指针从零位抬起又回落；Karin收住脚步，Rifa把视线从检查官移向指针\n- P04-F04 9-12s：执行关键动作：检查官把探测器转向Rifa；Karin与Rifa短暂交换视线，三人的站位被检查台拉开\n- P04-F05 12-15s：落到结果、反应或转场：探测器完全举在两人之间并保持零读数；法师的注视落定，二人停在检查台前等待放行\n\n### SH005 空白读数\n- P05-F01 0-3s：建立场景与动作入口：探测器屏幕保持空白；检查官的手停在读数上方，Karin与Rifa看向同一块空白刻度\n- P05-F02 3-6s：镜头推进并改变主体状态：锁链从闸门上方开始下落；Karin抬眼看向闸门，Rifa向后撤开半步\n- P05-F03 6-9s：镜头推进并改变主体状态：Karin向前迈出半步挡在Rifa前面；检查官收回探测器，闸门继续下降\n- P05-F04 9-12s：执行关键动作：锁链绷直，闸门落到闭合位置；Rifa侧身避开，Karin的手移向腰后断剑\n- P05-F05 12-15s：落到结果、反应或转场：空白读数映在闸门金属上；Karin挡在前方，Rifa保持侧后，盘查现场落入封锁结果\n\n### SH006 旧信号\n- P06-F01 0-3s：建立场景与动作入口：Karin拇指轻敲断剑护手发出旧信号；Rifa从侧后看见信号，双手仍垂在身侧\n- P06-F02 3-6s：镜头推进并改变主体状态：Rifa回敲同一节奏；两人同时转正肩线，手臂抬向尚未打开的封印线\n- P06-F03 6-9s：镜头推进并改变主体状态：两人同时把力量压入封印；银色细线从闸门缝隙亮起，尘埃被压力托离地面\n- P06-F04 9-12s：执行关键动作：封印向内凹陷，旗帜与衣角在无声压力中停住；两人手臂绷紧后开始收力\n- P06-F05 12-15s：落到结果、反应或转场：两人完全并肩站定，只保留一线未开的封印；Karin与Rifa同时看向闸门缝隙，旧信号动作落到结果\n\n### SH007 力量与观察\n- P07-F01 0-3s：建立场景与动作入口：封印压力扩散；旗帜、尘埃和探测器指针同时停住，世界短暂失去惯性\n- P07-F02 3-6s：镜头推进并改变主体状态：闸门周围的结界向两人凹陷；Karin与Rifa保持伸手姿态，远处高塔观察者转身看向异常\n- P07-F03 6-9s：镜头推进并改变主体状态：封印裂开一道可通行的银白缝隙；两人的力量达到峰值，闸门链条从内部断开\n- P07-F04 9-12s：执行关键动作：Karin先收回力量，Rifa慢半拍跟上；两人重新踩稳，闸门在身后开始打开\n- P07-F05 12-15s：落到结果、反应或转场：闸门完全打开；Karin与Rifa并肩站定，远处观察者隔着城市纵深继续注视\n\n### SH008 我问的是你\n- P08-F01 0-3s：建立场景与动作入口：城市沿陡坡在两人面前展开；Karin抬头寻找上行道路，Rifa与他并肩走在同一动线上\n- P08-F02 3-6s：镜头推进并改变主体状态：断剑撞上路边手推车；Karin立刻伸手护住剑鞘，Rifa停下半步看向他的手\n- P08-F03 6-9s：镜头推进并改变主体状态：Rifa放慢脚步与Karin对齐；她的视线从断剑移到Karin脸上，Karin把目光留在坡道前方\n- P08-F04 9-12s：执行关键动作：Karin的手从剑鞘边缘稍微松开又重新扣住；Rifa侧头等待回答，两人的步伐在坡道转折处停顿\n- P08-F05 12-15s：落到结果、反应或转场：两人重新并肩走到上行坡道尽头；Karin避开Rifa的视线，Rifa把目光投向前方门口\n\n### SH009 银色裂痕\n- P09-F01 0-3s：建立场景与动作入口：Edia Knight木门上的银色裂痕映入Karin眼中；他停在门外，手指靠近腰后断剑\n- P09-F02 3-6s：镜头推进并改变主体状态：木门向内打开；Karin与Rifa停在门槛，奥伦背对站在炉光深处\n- P09-F03 6-9s：镜头推进并改变主体状态：Karin把靠近断剑的手收回衣侧；Rifa向门内探看，奥伦仍不回头，三人的纵深开始拉开\n- P09-F04 9-12s：执行关键动作：Rifa转头确认Karin的反应；Karin避开她的视线，把梦境藏回沉默，奥伦的肩膀微微转动\n- P09-F05 12-15s：落到结果、反应或转场：三人停在门槛关系中；奥伦背对门内，Karin与Rifa并立门外，银纹冷光与炉火形成明确分界\n\n### SH010 你看见的是结果\n- P10-F01 0-3s：建立场景与动作入口：奥伦从铁砧旁抬眼质疑断剑为何被打断；Karin站在铁砧前，Rifa留在门侧观察\n- P10-F02 3-6s：镜头推进并改变主体状态：Karin取下断剑平放到铁砧上；Rifa的视线跟随剑身，奥伦伸手取来无头锤柄\n- P10-F03 6-9s：镜头推进并改变主体状态：奥伦把锤柄缓缓对准断口；Karin收紧手指但没有阻止，Rifa向门侧退开半步\n- P10-F04 9-12s：执行关键动作：锤柄触碰断口，炉火收成一线；Karin抬头看向奥伦，断剑裂痕映出冷银光\n- P10-F05 12-15s：落到结果、反应或转场：锤柄停在断口上，三人不再移动；奥伦的手、Karin的断剑和Rifa的视线共同落到被打断的结果\n\n### SH011 借她的记忆\n- P11-F01 0-3s：建立场景与动作入口：断剑旁的记忆残影显出一条暗红线；Karin低头看向自己的手腕，Rifa发现线条与她的辫绳相似\n- P11-F02 3-6s：镜头推进并改变主体状态：暗红线沿Karin手腕向断剑延伸；Karin想把手收回，Rifa抬手阻止他的动作\n- P11-F03 6-9s：镜头推进并改变主体状态：Rifa抓住Karin手腕；她的辫绳与记忆中的红线重合，奥伦向前半步确认相接的手\n- P11-F04 9-12s：执行关键动作：Karin的手腕在Rifa掌中绷紧又停住；Rifa没有松手，奥伦的手停在断剑上方\n- P11-F05 12-15s：落到结果、反应或转场：暗红线与辫绳同时落入冷光；Rifa仍抓住Karin，奥伦注视相接的手，记忆结果切回现实\n\n### SH012 拒绝完整\n- P12-F01 0-3s：建立场景与动作入口：奥伦的解释停在半句；窄木匣从铁砧下被推到前景，Karin与Rifa同时把视线移向匣面\n- P12-F02 3-6s：镜头推进并改变主体状态：木匣盖弹开，四个微光点依次亮起；Rifa的手靠近短刃，Karin盯住匣内的冷光\n- P12-F03 6-9s：镜头推进并改变主体状态：烟黑铜镜在匣内反射出高塔观察者；Karin抬头，Rifa转向镜面，奥伦的手停在熄灭的炉膛旁\n- P12-F04 9-12s：执行关键动作：炉火完全熄灭，铜镜中的观察者保持清晰；短刃从鞘中滑出半寸，三人的视线被镜面分开\n- P12-F05 12-15s：落到结果、反应或转场：木匣四点微光、铜镜观察者和半出鞘短刃同时落入静止终点；答案结束，新问题被留下"
      },
      {
        "code": "SEC12",
        "title": "十二、资产映射与执行顺序",
