                ...
                items: {
                    ...
                    properties: {
                        ...
                        entryState: {
                            type: "object",
                            description:
                                "镜头开始时的可观察状态：characters 每项必须写 assetId、position、gaze、pose、action，必要时补 wardrobe/expression；props 每项必须写 assetId、state、holderId；另写环境、光色和轴线。跨硬切继承时必须与上一镜 exitState 逐项一致；只有明确写出移动路径/受力和到达结果才允许改变位置。",
                        },
                        exitState: {
                            type: "object",
                            description:
                                "镜头结束时的可观察状态：characters 每项必须写 assetId、position、gaze、pose、action，必要时补 wardrobe/expression；props 每项必须写 assetId、state、holderId；另写环境、光色和轴线，供下一镜继承。下一镜可以硬切开始，但不得因此重置站位。",
                        },
