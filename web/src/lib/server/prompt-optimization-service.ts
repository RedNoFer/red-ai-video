...
export function optimizeCreativePrompt(input: { origin: string; cookie: string; userId: string; requestId: string; prompt: string; mode: "drama-asset" }): Promise<DramaAssetPromptOptimization>;
export function optimizeCreativePrompt(input: { origin: string; cookie: string; userId: string; requestId: string; prompt: string; mode: NonAssetPromptOptimizationMode }): Promise<string>;
export function optimizeCreativePrompt(input: { origin: string; cookie: string; userId: string; requestId: string; prompt: string; mode: PromptOptimizationMode }): Promise<string | DramaAssetPromptOptimization>;
export async function optimizeCreativePrompt(input: { origin: string; cookie: string; userId: string; requestId: string; prompt: string; mode: PromptOptimizationMode }): Promise<string | DramaAssetPromptOptimization> {
