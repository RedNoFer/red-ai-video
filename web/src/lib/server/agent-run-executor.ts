...
import { buildDramaAssetReuseContext, mergeDramaProductionPackageShotDurations, previewDramaProductionPackage } from "@/lib/server/drama-production-package";
        ...
        try {
            ...
            if (parsed.mode === "package") {
                ...
                if (lockedPlan) {
                    ...
                    preview = previewDramaProductionPackage(serializeDramaProductionPackageMarkdown(rebalanced), "剧本 Agent 制作包.md", project);
                }
