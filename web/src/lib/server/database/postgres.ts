...
const POSTGRES_TABLES = [
    ...
    "drama_production_runs",
    "drama_asset_generation_batches",
    "creative_run_events",
    "audit_logs",
    "check_ins",
] as const;
...
const POSTGRES_SCHEMA_OBJECTS = [
    ...
    "creative_conversations_episode_idx",
    ...
    "drama_production_runs_user_project_idx",
    "drama_asset_generation_batches_user_project_idx",
