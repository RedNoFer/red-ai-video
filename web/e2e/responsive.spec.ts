        ...
        scenes: [
            {
                ...
                sceneReferenceBoard: { layout: "legacy-3x3", referenceId: "scene-one-ref" },
                ...
                shots: [
                    {
                        ...
                        videoPrompt: [
                            "动态意图：Karin在黑湖边从停住转身并锁定湖心",
                            "时间段动作：",
                            "0-2s",
                            "起点：Karin在湖岸停住，眉头微皱，目光看向湖心",
                            "动作与触发：风掠过水面，Karin手指收紧",
                            "可见衔接：她的视线转向湖心",
                            "终点：Karin转身面对湖心",
                            "2-5s",
                            "起点：Karin转身面对湖心",
                            "动作与触发：她抬眼并向前倾身",
                            "可见衔接：冷雾绕过肩线，水面反光随风移动",
                            "终点：Karin盯住湖心，肩背绷紧",
                            "单一主运镜：中景轻微推进",
                            "结束画面：Karin转身看向湖心，冷雾压住高塔轮廓",
                        ].join("\n"),
